...
myface1_height = myface1_size[1]

# ╔═╡ f08d02af-6e38-4ace-8b11-7af4930b64ea
myface1_width = myface1_size[2]
...
@bind row_i Slider(1:size(myface1)[1], show_value=true)

# ╔═╡ 6511a498-7ac9-445b-9c15-ec02d09783fe
@bind col_i Slider(1:size(myface1)[2], show_value=true)
...
myface_eyes = myface1[30:50, 40:90]
...
@bind range_rows RangeSlider(1:size(myface_eyes)[1])

# ╔═╡ 85919db9-1444-4904-930f-ba572cff9460
@bind range_cols RangeSlider(1:size(myface_eyes)[2])

# ╔═╡ 2ac47b91-bbc3-49ae-9bf5-4def30ff46f4
nose = myface_eyes[range_rows, range_cols]
...
# ╔═╡ b2ef7488-aaa7-464e-b181-bb6fd95b1103
test_r
...
function invert(color::AbstractRGB)
	...
	inverted_r = 1.0 - color.r
	inverted_g = 1.0 - color.g
	inverted_b = 1.0 - color.b
	new_color =  RGB(inverted_r, inverted_g, inverted_b)
...
# ╔═╡ 4e5c131d-04de-430d-a31e-b6288180918d
color_black.g

# ╔═╡ ee4205b1-afe0-46ac-900f-debda4f3ec24
typeof(color_black)
...
# ╔═╡ 09f92cf1-46e6-4469-aae6-fa224904c26d
myface_invert = map(invert, myface1)
...
function create_bar()
	my_vector = zeros(100)
	center_twenty = (length(my_vector) ÷ 2 - 9):(length(my_vector) ÷ 2 + 10)
	my_vector[center_twenty] .= 1
	return my_vector
end
...
reduced_image = myface1[1:3:end, 1:3:end]
...
save("reduced_brandon.png", reduced_image)
...
# ╔═╡ 7eeefce2-c191-4595-a782-fc521e61964d
[1,2,RGB(1,0,0), "hello"]

# Julia does not care at all what is inside an array
...
# ╔═╡ 3ccdb5bb-bb69-4ada-9620-da36505c6f8d
[i^2 for i ∈ 1:10]

# use \in and then hit tab to get 
...
[myface1                   reverse(myface1, dims=2)
 reverse(myface1, dims=1)  rot180(myface1)]
